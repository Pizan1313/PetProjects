...
#### В этой таблице хранится связь между местом происхождения вина и коммунами, в которых может быть собран виноград.

- `origin_id`: Уникальный идентификатор места происхождения.
- `commune_id`: Уникальный идентификатор коммуны.

### Таблица `origin_vineyard`
#### Эта таблица устанавливает связь между местом происхождения вина и виноградниками, откуда собирается виноград.

- `origin_id`: Уникальный идентификатор места происхождения.
- `vineyard_id`: Уникальный идентификатор виноградника.

### Таблица `origin_lieu_dit`
#### Здесь хранится информация о связи между местом происхождения вина и льё-ди, откуда собирается виноград.

- `origin_id`: Уникальный идентификатор места происхождения.
- `lieu_dit_id`: Уникальный идентификатор льё-ди.

### Таблица `vintage_grape_blend`
#### Эта таблица связывает вино с сортами винограда, из которых оно было произведено.

- `vintage_id`: Уникальный идентификатор вина.
- `grape_id`: Уникальный идентификатор сорта винограда.

### Таблица `vintage_wine_image`
#### Здесь хранятся связи между винтажами и изображениями вина.
...
#### Эта таблица позволяет связать винодела с фотографиями его винодельни.
...
#### В этой таблице устанавливаются связи между виноделами и поставщиками.

- `producer_id`: Уникальный идентификатор винодела.
- `shipper_id`: Уникальный идентификатор поставщика.

### Таблица `vintage_quality`
#### Эта таблица описывает качество винтажей в зависимости от места происхождения.
...
#### Эта таблица позволяет категоризировать вина в зависимости от страны производства и имеет иерархическую структуру.
